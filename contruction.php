...
<html lang="en">
  ...
  <body>
    ...
    <h2
      class="text-success"
      style="margin-left: 2rem; margin-right: 2rem; margin-top: 2rem"
    >
    <!-- icon  -->
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-house-gear" viewBox="0 0 16 16">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-screwdriver" viewBox="0 0 16 16">
      ...
      Home construction item repairing shops in ------ loction
    </h2>
    ...
    >
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          <img src="demo.jpg" class="d-block w-100" alt="..." />
        </div>
    ...
    <div>
      <div class="card mb-3">
        ...
        <div class="card-body">
          <h5 class="card-title">Laxmi Electronics</h5>
          <p class="card-text">
            Laxmi Electronic is best in x city. Find best service in our city.
            Come and try our service. I think you are going to love our
            services. 30% off for students.
          </p>
          <p class="card-text">
            <small class="text-muted"
              >Open at 9:00am and close at 10:00pm</small
            >
          </p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
